    ...
    [...data].sort((a,b) => new Date(b.date) - new Date(a.date)).forEach(tx => {
        ...
        if(tx.status === 'hutang') cr = `<div class="badge-cat" style="border: 1px solid var(--merah); color:var(--merah); background:rgba(239,68,68,0.2);">HUTANG</div>`;
            ...
            <td style="vertical-align:middle; text-align:right; white-space: nowrap;">
                <div style="display:flex; align-items:center; justify-content:flex-end; gap:12px; flex-wrap:nowrap;">
                    ...
                    <span class="amt-cell" style="color:${iM?'var(--biru)':'var(--merah)'}; margin:0; line-height:1; min-width:105px; text-align:right; display:inline-block; flex-shrink:0;">${iM?'+':'-'}${formatRp(tx.amount)}</span>
                </div>
            </td>
        </tr>`;
    });
...
// Handler pencegat event klik ganda (mencegah Receipt Modal terbuka saat klik Edit/Hapus di Tabel)
